...
*/
	...
	// operateur == : forçage de  type ---> on ne compare que les valeurs
	//false == 0 est vrai

	//operateur === : comparaison des types, puis des valeurs
	//donc false===0 est faux


	// En fonction de la vue à afficher, on appelle tel ou tel template
	//le fichier s'affiche (on l'insère)
	switch($view)
	{		
