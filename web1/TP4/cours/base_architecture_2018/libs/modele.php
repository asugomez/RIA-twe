...
function interdireUtilisateur($idUser)
{
	...
	// si l'utilisateur enoie id=
	// UPDATE users SET blacklist=1 WHERE id=3; drop tables users;
	//--> INJECTION SQL 

	//TODO:  a faire cette solution!
	//premiere solution : la meilleure: requetes preparees
	//exec_SQL(format, arg1, arg2)

	//Notre solutoin: encadrer les arguments par des apostrophes
	// et banaliser d'éventuelles apostrophes dans les chaines qui viennent du client: 
	//fonction addslashs
