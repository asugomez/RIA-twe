...
<?php
/**
 * considerons le formulaire presents dans la page users.php
 * 1. a quelle page sont envoyes les données du formulaire?
 * --> controleurs.php
 ...
 * 
 * 3. COmpleter les labels du menu deroulant pour y afficher les statuts des utilisateurs 
 * ('bl' ou 'nbl') en plus de leurs noms 
 */
$users = listerUtilisateurs();
//tableau de trableaux associatifs 
